import { reactive, hasInjectionContext, getCurrentInstance, toRef, isRef, inject, nextTick, shallowRef, shallowReactive, isReadonly, version, ref, watchEffect, watch, unref, isShallow, isReactive, toRaw, getCurrentScope, onScopeDispose, onUnmounted, computed, defineComponent, useSlots, h, resolveComponent, onUpdated, Suspense, mergeProps, Transition, provide, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./assets/about-cf110154.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./assets/index-0451f8c2.js").then((m) => m.default || m)
  },
  {
    name: "project-id",
    path: "/project/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./assets/_id_-f5130829.js").then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./assets/projects-1be4d70a.js").then((m) => m.default || m)
  },
  {
    name: "projectsEdit",
    path: "/projectsEdit",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./assets/projectsEdit-f443b249.js").then((m) => m.default || m)
  },
  {
    name: "services",
    path: "/services",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./assets/services-f66fb787.js").then((m) => m.default || m)
  }
];
...
const component = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    ...
    if (((_a = process == null ? void 0 : process.env) == null ? void 0 : _a.NODE_ENV) === "development" || (process == null ? void 0 : process.dev)) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./assets/error-404-1f0507a4.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./assets/error-500-9dba7812.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./assets/island-renderer-2e937f38.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
